...
public class SetPractice2 {
    ...
    public static void main(String[] args) {
       ...
       // System.out.println( new ArrayList<>(names).get(4)  );
        ...
        String password = "aaawwwdddeeeaawfffvvviii";
        ...
        for (String each : new LinkedHashSet<>(Arrays.asList(passArr))) {
            resultOfPassword += each + Collections.frequency(Arrays.asList(passArr), each);
